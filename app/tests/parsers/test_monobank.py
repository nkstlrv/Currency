...
def test_monobank_parser_prevent_duplicates(mocker):
    ...
    Rate.objects.create(
        buy="39.63", sell="41.00", source=source, currency=RateCurrencyChoices.EUR
    )
    Rate.objects.create(
        buy="36.64", sell="37.44", source=source, currency=RateCurrencyChoices.USD
    )
